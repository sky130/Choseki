...
class ChosekiDatabaseHelper(context: Context) :
    ...
    companion object {
        ...
        private const val DATABASE_NAME = "Choseki"
    }

    override fun onCreate(db: SQLiteDatabase?) {
        db?.execSQL("CREATE TABLE IF NOT EXISTS package (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, package_id INTEGER, version INTEGER, icon TEXT,isEnable INTEGER)")
